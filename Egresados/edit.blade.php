        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2">
                <div class="card card-primary">
                    ...
                    <div class="card-body ">
                        <form  method="post" action="{{ route('Egresados.update', [$egresado->egresados_id]) }}">
                            {!! method_field('PUT') !!}
                            {!! csrf_field() !!}
                            @if (count($errors)>0)
                                <ul>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-8">
                                ...
                                value="{{ $egresado->apellido_paterno }}" required autocomplete="apellido" autofocus>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-xs-8">
                                ...
                                value="{{ $egresado->apellido_materno }}" required autocomplete="apellidoma" autofocus>
                            </div>
                            <div class="form-group col-xs-4">
                                ...
                                value="{{ $egresado->nombre }}" required autocomplete="nombre" autofocus>
                            </div>
                        </div>
                        <div class="row">                         
                            <div class="form-group col-xs-4">
                                ...
                                value="{{ $egresado->carrera }}" required autocomplete="nombre" autofocus>
                            </div>
                            <div class="form-group col-xs-4">
                                ...
                                value="{{ $egresado->correo_electronico }}" required autocomplete="correo" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-4">
                                ...
                                value="{{ $egresado->numero_telefono }}" required autocomplete="numero" autofocus>
                            </div>                            
                            <div class="form-group col-xs-4">
                                ...
                                value="{{ $egresado->año_egreso }}" required autocomplete="egreso" autofocus>
                            </div>
                            <div class="form-group col-xs-4">
                                ...
                                value="{{ $egresado->period_id }}" required autocomplete="periodo" autofocus>
                            </div>
