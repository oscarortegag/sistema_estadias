...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>SUT</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>{{config('app.name')}}</b> UT Chetumal </span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                {{-- <p>{{auth()->user()->getRoleDisplayNames  ()->implode(', ')}}</p> --}}
                <!-- Status -->
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; {{ now()->year }} <a href="http://www.utchetumal.edu.mx/index/">Universidad Tecnológica de Chetumal </a>.</strong> {{-- All rights reserved. --}}
    </footer>
