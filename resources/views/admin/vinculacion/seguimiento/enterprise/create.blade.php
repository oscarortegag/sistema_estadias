                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('enterprise.store') }}">
                            ...
                            <div class="form-group">
                                <label for="nombreasesor" class="col-form-label text-md-right">Nombre del asesor empresarial</label>
                            ...
                            <div class="form-group">
                                <label for="correoasesor" class="col-form-label text-md-right">Correo del asesor empresarial</label>
                            ...
                            <div class="form-group">
                                <label for="telefonoasesor" class="col-form-label text-md-right">Teléfono del asesor empresarial</label>
                            ...
                            <div class="form-group">
                                <label for="nombrecontacto" class="col-form-label text-md-right">Nombre del contacto empresarial</label>
                            ...
                            <div class="form-group">
                                <label for="correocontacto" class="col-form-label text-md-right">Correo del contacto empresarial</label>
                            ...
                            <div class="form-group">
                                <label for="telefonocontacto" class="col-form-label text-md-right">Teléfono del contacto empresarial</label>
